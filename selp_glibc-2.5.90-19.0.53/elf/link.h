...
/* Hooks for debugging. */
extern void (*__dl_init_trace) (const ElfW(Addr) __addr, const char *__name,
				const ElfW(Phdr) *__phdr, ElfW(Half) __phnum);
extern void (*__dl_fini_trace) (const ElfW(Addr) __addr, const char *__name,
				const ElfW(Phdr) *__phdr, ElfW(Half) __phnum);
