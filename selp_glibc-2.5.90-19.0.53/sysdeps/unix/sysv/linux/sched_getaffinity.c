...
# endif
# if SHLIB_COMPAT (libc, GLIBC_2_3_2, GLIBC_2_3_4)
strong_alias (__sched_getaffinity_new, __sched_getaffinity_new_);
compat_symbol (libc, __sched_getaffinity_new_, sched_getaffinity, GLIBC_2_3_2);
# endif
#else
