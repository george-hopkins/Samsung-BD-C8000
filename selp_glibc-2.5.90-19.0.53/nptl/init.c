...
__pthread_initialize_minimal_internal (void)
{
  ...
  /* To adjust thread's default priority.
   * int which = PRIO_PROCESS;
   * printf ("DEBUG: data info  which(%d) ,pd->tid(%d) \r\n",PRIO_PROCESS , pd->tid);
   * printf ("DEBUG: Default thread priority value is (%d) \r\n",getpriority(PRIO_PROCESS , pd->tid));
   */
   if (setpriority(PRIO_PROCESS, pd->tid, THREAD_DEFAULT_PRIORITY ) ){
