...
void MPEGaudio::extractlayer2(void)
{
  ...
  unsigned int scaleselector[MAXCHANNEL][MAXSUBBAND] ;
  ...
  REAL c[MAXCHANNEL][MAXSUBBAND] ;
  REAL d[MAXCHANNEL][MAXSUBBAND] ;

  int s=stereobound,n=subbandnumber;

//init
	memset(bitalloc, 0x0, sizeof(unsigned int )*MAXCHANNEL*MAXSUBBAND);
	memset(scaleselector, 0x0, sizeof(unsigned int )*MAXCHANNEL*MAXSUBBAND);
	memset(scalefactor, 0x0, sizeof(REAL)*2*3*MAXSUBBAND);	

	memset(group, 0x0, sizeof(REAL)*MAXCHANNEL*MAXSUBBAND);
	memset(codelength, 0x0, sizeof(unsigned int )*MAXCHANNEL*MAXSUBBAND);
	memset(factor, 0x0, sizeof(REAL)*MAXCHANNEL*MAXSUBBAND);
	memset(c, 0x0, sizeof(REAL)*MAXCHANNEL*MAXSUBBAND);
	memset(d, 0x0, sizeof(REAL)*MAXCHANNEL*MAXSUBBAND);
