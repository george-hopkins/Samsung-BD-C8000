...
#define O_PMU_PLL0_K_CON		(0x18)
#define O_PMU_PLL2_K_CON		(0x1C)
#define O_PMU_PLL4_K_CON		(0x20)
#define O_PMU_PLL5_K_CON		(0x24)

#define O_PMU_PLL_BYPASS		(0x58)
#define O_PMU_MUX_SEL0			(0x80)
...
#define R_PMU_PLL0_K_CON		VA_PMU(O_PMU_PLL0_K_CON)
...
#define O_GPIO_CON5			(0x8c)
#define O_GPIO_PWDATA5		(0x90)

#define O_EXTINT_REG		(0xA0)
#define O_EXTINT_SEL		(0xA4)
#define O_EXT_BYPASS		(0xA8)
#define O_GPIO_CON6			(0xE8)
#define O_GPIO_PWDATA6		(0xEC)

#define R_GPIO_CON5			VA_PADCTRL_PORT(O_GPIO_CON5)
#define R_GPIO_PWDATA5		VA_PADCTRL_PORT(O_GPIO_PWDATA5)

#define R_EXTINT_REG		VA_PADCTRL_PORT(O_EXTINT_REG)
#define R_EXTINT_SEL		VA_PADCTRL_PORT(O_EXTINT_SEL)
#define R_EXT_BYPASS		VA_PADCTRL_PORT(O_EXT_BYPASS)
#define R_GPIO_CON6			VA_PADCTRL_PORT(O_GPIO_CON6)
#define R_GPIO_PWDATA6		VA_PADCTRL_PORT(O_GPIO_PWDATA6)
