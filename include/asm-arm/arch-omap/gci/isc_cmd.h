...
#define CAM_PASST_SLAVE_ADDR		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x10)
#define CAM_PASST_FORMAT		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x11)
#define CAM_PASST_REG_ADDR_L		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x12)
#define CAM_PASST_REG_ADDR_H		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x13)
#define CAM_PASST_REG_DATA_L		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x14)
#define CAM_PASST_REG_DATA_H		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x15)
#define CAM_PASST_STATUS		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x16)
#define CAM_PASST_AI			ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x17)
#define CAM_PASST_BUS_SPEED		ADDRESS(ATTRIB_READ_WRITE,PAGEA,0x18)
