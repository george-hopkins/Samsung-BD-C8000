...
#if defined (CONFIG_MIPS_BCM_NDVD)
	/*
	 * Reset the SCSI command timer
	 * We don't want to time out a command before it can get out
	 * on the wire.
	 */
...
#if defined (CONFIG_MIPS_BCM_NDVD)
		{
			int ATAPI_ERRINFO = 1;		// need confirm..
...
#if defined (CONFIG_MIPS_BCM_NDVD)
	{
		int NO_EARLY_SPINUP = 1;	// need confirm..
		/*
