...
/**
 * nand_unlock - [NAND Interface] Unlock a region of the NAND device
 * @mtd:	     MTD device structure
 * @off:	     Offset into device to unlock
 * @size:	     Size of region to unlock
 */
static int nand_unlock(struct mtd_info *mtd, loff_t off, size_t size)
{
