...
#elif defined(CONFIG_MACH_OMAP_3430SDP) && defined(CONFIG_OMAP3430_ES2)
...
#elif defined(CONFIG_MACH_OMAP3EVM)
	omap_free_gpio(LCD_PANEL_LR);     /* LR */
	omap_free_gpio(LCD_PANEL_UD);     /* UD */
	omap_free_gpio(LCD_PANEL_INI);    /* INI */
	omap_free_gpio(LCD_PANEL_RESB);   /* RESB */
	omap_free_gpio(LCD_PANEL_QVGA);   /* QVGA */
#endif
