 ...
 *     SCSI_SCAN_LUN_PRESENT: a new scsi_device was allocated and initialized
 **/
unsigned char bdp_sd_inquiry[32]; //by gyu
EXPORT_SYMBOL(bdp_sd_inquiry);
...
#if 1 //by gyu
	memcpy((unsigned char*)bdp_sd_inquiry, (result + 8), 8);
	memcpy((unsigned char*)(bdp_sd_inquiry+8), (result + 16), 16);
	memcpy((unsigned char*)(bdp_sd_inquiry+24), (result + 32), 4);
#endif
