		 ...
		 void *arg1, void *arg2)
{
	...
	case CBK_HIST_DONE:
		...
		break;	
	case CBK_LSC_ISR:
		omap_writel(IRQ0ENABLE_CCDC_LSC_DONE_IRQ | IRQ0ENABLE_CCDC_LSC_PREF_COMP_IRQ
				| IRQ0ENABLE_CCDC_LSC_PREF_ERR_IRQ, ISP_IRQ0STATUS);
...
isp_unset_callback(enum isp_callback_type type)
{
	...
	case CBK_LSC_ISR:
	  omap_writel(omap_readl(ISP_IRQ0ENABLE) & ~(IRQ0ENABLE_CCDC_LSC_DONE_IRQ 		
 				| IRQ0ENABLE_CCDC_LSC_PREF_COMP_IRQ | IRQ0ENABLE_CCDC_LSC_PREF_ERR_IRQ),
				ISP_IRQ0ENABLE);
		break;			
	default:
		break;
...
/* Master save restore context function */
void
isp_save_ctx(void)
{
...
/*
 * Saves the values of the ISP CTRL module registers.
 */
void 
...
/*
 * Restores the values of the ISP CTRL module registers.
 */
void 
...
EXPORT_SYMBOL(isp_CCDC_VD01_disable);
EXPORT_SYMBOL(isp_CCDC_VD01_enable);
