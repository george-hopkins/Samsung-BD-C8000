...
/* SELP.4.3.1.x patch, print bitmask based cache type, backporting from 2.6.28, 2009-10-27 */
...
#define _cache_is_vivt()         cacheid_is(CACHEID_VIVT)
#define _cache_is_vipt()         cacheid_is(CACHEID_VIPT)
#define _cache_is_vipt_nonaliasing() cacheid_is(CACHEID_VIPT_NONALIASING)
#define _cache_is_vipt_aliasing()    cacheid_is(CACHEID_VIPT_ALIASING)
#define _icache_is_vivt_asid_tagged()    cacheid_is(CACHEID_ASID_TAGGED)
...
{
    unsigned int cachetype = read_cpuid(CPUID_CACHETYPE);
    ...
    printk("CPU: %s data cache, %s instruction cache\n",
        _cache_is_vivt() ? "VIVT" :
        _cache_is_vipt_aliasing() ? "VIPT aliasing" :
        _cache_is_vipt_nonaliasing() ? "VIPT nonaliasing" : "unknown",
        _cache_is_vivt() ? "VIVT" :
        _icache_is_vivt_asid_tagged() ? "VIVT ASID tagged" :
        _cache_is_vipt_aliasing() ? "VIPT aliasing" :
        _cache_is_vipt_nonaliasing() ? "VIPT nonaliasing" : "unknown");
}
