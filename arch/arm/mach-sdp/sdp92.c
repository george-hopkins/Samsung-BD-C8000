...
static struct map_desc sdp92_io_desc[] __initdata = {
/* ------------------------------------------- */
/* ------ special function register ---------- */
/* ------------------------------------------- */
// 0x3000_0000 ~ 0x30b0_0000, 11Mib
 { 
	.virtual = 0xf8000000,
...
static struct platform_device* sdp92_init_devs[] __initdata = {
	&sdp_uart0,
	&sdp_uart1,
	&sdp_uart2,
       	&sdp_ehci0,
...
void __init sdp92_iomap_init (void)
{
	iotable_init(sdp92_io_desc, ARRAY_SIZE(sdp92_io_desc));
}

void __init sdp92_init(void)
{
#if defined(CONFIG_SDP92_GPIO)
	sdp92_gpio_init();
#endif
	platform_add_devices(sdp92_init_devs, ARRAY_SIZE(sdp92_init_devs));
}
