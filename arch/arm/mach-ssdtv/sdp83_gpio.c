...
static struct sdp_gpio_port sdp83_gpio_ports[] = {
	{
		.portno = 0,
		.npins = 8,
		.reg_offset = 0x50,
...
void __init sdp83_gpio_init(void)
{
	sdp_gpio_add_device (PA_PADCTRL_BASE, 4096, sdp83_gpio_ports, ARRAY_SIZE(sdp83_gpio_ports));
}
