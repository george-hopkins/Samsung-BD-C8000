...
#define AHB_PCI_CONFIG_TYPE0_BASE 	0x50000000UL
#define AHB_PCI_CONFIG_TYPE1_BASE 	0x54000000UL
#define AHB_PCI_IO_BASE			0x5C000000UL
                                                                                
/* XXX: see arch/arm/mach-sdp/mach-xxx.c */
...
typedef volatile struct {
	...
	volatile u32	reserved9[4];			/* 0x800 ~ 0x80C */
