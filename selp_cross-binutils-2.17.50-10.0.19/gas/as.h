...
/* TRUE if we should generate .license section. */
COMMON int gen_license_section;

/* License section text or NULL if env variable used.*/
COMMON char *license_section_text;
