...
/* True if -mfix-24ke enabled.  */
static int mips_fix_24ke;
	     ...
	     bfd_reloc_code_real_type *reloc_type)
{
  ...
  if (address_expr
	...
	as_warn (_("extended instruction in delay slot"));
      ...
      if (mips_fix_24ke
	  && (prev_pinfo & INSN_COND_BRANCH_LIKELY) != 0
	  && (pinfo & (FP_S | FP_D | INSN_COP)) != 0)
	{
	  as_warn (_("Instruction in delay slot is affected by 24KE errata"));
	}
...
#define OPTION_FIX_24KE (OPTION_FIX_BASE + 6)
#define OPTION_NO_FIX_24KE (OPTION_FIX_BASE + 7)
  {"mfix-24ke",    no_argument, NULL, OPTION_FIX_24KE},
  {"mno-fix-24ke", no_argument, NULL, OPTION_NO_FIX_24KE},
...
md_parse_option (int c, char *arg)
{
  switch (c)
    ...
    case OPTION_FIX_24KE:
      mips_fix_24ke = 1;
      break;

    case OPTION_NO_FIX_24KE:
      mips_fix_24ke = 0;
      break;
...
-mfix-24ke		work around 24KE errata\n\
