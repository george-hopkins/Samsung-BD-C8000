...
typedef int             (*xfs_bmap_trunc_t)(struct xfs_trans *,
                                void *, xfs_fileoff_t,
                                xfs_filblks_t, int, xfs_extnum_t,
                                xfs_fsblock_t *, struct xfs_bmap_free *,
                                struct xfs_extdelta *, int *);
...
typedef int             (*xfs_bmap_split_t)(struct xfs_trans *,
                                void *, xfs_fileoff_t,
                                xfs_filblks_t, int, xfs_extnum_t,
                                xfs_fsblock_t *, struct xfs_bmap_free *,
                                struct xfs_extdelta *, int *, xfs_split_data_t*);
#endif
...
#ifdef CONFIG_XFS_FS_SPLIT
        xfs_bmap_split_t                xfs_bmap_split_func;
#endif
#ifdef CONFIG_XFS_FS_TRUNCATE_RANGE
        xfs_bmap_trunc_t                xfs_bmap_trunc_func;
#endif
...
#ifdef CONFIG_XFS_FS_SPLIT
#define XFS_BMAP_SPLIT(mp, trans,io,bno,len,f,nexts,first,flist,delta,done,split_data) \
        (*(mp)->m_io_ops.xfs_bmap_split_func) \
                (trans,(io)->io_obj,bno,len,f,nexts,first,flist,delta,done,split_data)
#endif
#ifdef CONFIG_XFS_FS_TRUNCATE_RANGE
#define XFS_BMAP_TRUNC(mp, trans,io,bno,len,f,nexts,first,flist,delta,done) \
        (*(mp)->m_io_ops.xfs_bmap_trunc_func) \
                (trans,(io)->io_obj,bno,len,f,nexts,first,flist,delta,done)
