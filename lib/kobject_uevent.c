...
static const char *kobject_actions[] = {
	...
	[KOBJ_NOTSUPPORTED_DEV_ADD] = "unknown_dev_add",
	[KOBJ_NOTSUPPORTED_DEV_REMOVE] = "unknown_dev_remove",
};
...
//VD_COMP_USB_PATCH
  ...
  ***********************************************************************+  
  // add compare strings "bt_usb" and "csr_usb" for pass bluetooth devices +  
  **********************************************************************/
 if (!devpath ||
  (( strstr(devpath, "block/sd") == NULL ) &&
  (strstr(devpath, "bt_usb") == NULL ) &&
  (strstr(devpath, "csr_usb") == NULL ) &&
  (strstr(action_string, "unknown_dev_add") == NULL ) &&
  (strstr(action_string, "unknown_dev_remove") == NULL )))
 {
